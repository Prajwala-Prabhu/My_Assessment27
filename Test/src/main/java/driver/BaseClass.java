...
public class BaseClass {
    ...
    public static void click(WebElement element, String stepDetail){
        try{
            element.click();
            test.log(LogStatus.PASS, stepDetail,"Successfully clicked on the element");
        }catch (Exception e){
    ...
    public static void initiateTest(String testName){
        ...
        reports=new ExtentReports(System.getProperty("user.dir")+"\\Reports\\ExtentReportResults"+timeStamp+".html");
    ...
    public static String capture(WebDriver driver) throws IOException {
        ...
        File Dest = new File(System.getProperty("user.dir")+"\\Reports\\Screenshots\\screenshot" + System.currentTimeMillis()+".png");
